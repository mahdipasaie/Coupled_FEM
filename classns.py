...
class NS:
    ...
    def smooth_heaviside(self, phi, epsilon):

        return 0.5 * (1 + self.tanh(phi / epsilon))
    ...
    def form(self):
        ...
        penalization = beta * H * fe.inner(self.u, self.v) 
    ...
    def BC(self):
        ...
        maxy = self.parameters_dict.get("maxy")
        ...
        inflow_profile = fe.Expression(('(x[1] >= maxy) ? velx  : 0.0', '0.0'), velx=velx, Ny=Ny, maxy=maxy, degree=2)
